...
from codaparser import ParseTable, Production
...
W = Production('W', {0: (chord,), 1: (note,), 2: (rest,)})

parse_table = ParseTable()
# Populate table
parse_table.register_entry(('S', declarator), S.rules[0])
parse_table.register_entry(('I', declarator), I.rules[0])
parse_table.register_entry(('K', key), K.rules[0], nodable=True)
parse_table.register_entry(('M', sig), M.rules[0], nodable=True)
parse_table.register_entry(('D', tmp), D.rules[0], nodable=True)
...
parse_table.register_entry(('C', typ), C.rules[0], nodable=True)
parse_table.register_entry(('C', rep), C.rules[0], nodable=True)
parse_table.register_entry(('C', grp), C.rules[0], nodable=True)
parse_table.register_entry(('C', lbrace), C.rules[0], nodable=True)
parse_table.register_entry(('C', eof), ('_',))
parse_table.register_entry(('T', typ), T.rules[0], nodable=True)
parse_table.register_entry(('T', rep), ('_',))
parse_table.register_entry(('T', grp), ('_',))
parse_table.register_entry(('T', lbrace), ('_',))
parse_table.register_entry(('R', rep), R.rules[0], nodable=True)
parse_table.register_entry(('R', grp), ('_',))
parse_table.register_entry(('R', lbrace), ('_',))
parse_table.register_entry(('G', grp), G.rules[0], nodable=True)
...
parse_table.register_entry(('N', rest), N.rules[0])
...
parse_table.register_entry(('Np', conn), Np.rules[0], nodable=False)
parse_table.register_entry(('Np', cconn), Np.rules[1], nodable=False)
parse_table.register_entry(('W', chord), W.rules[0], nodable=True)
parse_table.register_entry(('W', note), W.rules[1], nodable=True)
parse_table.register_entry(('W', rest), W.rules[2], nodable=True)
