...
K = Production('K', {0: (key, lbracket, keysig, rbracket)}, nodable=True)
M = Production('M', {0: (sig, lbracket, number, sep, number, rbracket)}, nodable=True)
D = Production('D', {0: (tmp, lbracket, number, rbracket)}, nodable=True)
B = Production('B', {0: ('C', 'Bp')})
Bp = Production('Bp', {0: ('C', 'Bp'), 1: ('_',)})
C = Production('C', {0: ('T', 'R', 'G', lbrace, 'B', rbrace), 1: ('N',)}, nodable=True)
T = Production('T', {0: (typ, lbracket, number, rbracket), 1: ('_',)}, nodable=True)
R = Production('R', {0: (rep, lbracket, number, rbracket), 1: ('_',)}, nodable=True)
G = Production('G', {0: (grp, lbracket, number, rbracket), 1: ('_',)}, nodable=True)
N = Production('N', {0: ('W', 'Np')})
Np = Production('Np', {0: (conn, 'N'), 1: (cconn, 'N'), 2: ('_',)})
W = Production('W', {0: (chord,), 1: (note,)}, nodable=True)
